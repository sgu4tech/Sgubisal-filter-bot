...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002081252535'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002081252535'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002081252535'))
...
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'https://indishort.live)
SHORTENER_API2 = environ.get("SHORTENER_API2", "dzLY1n15YccA4axkJK2QgyOQJJs1")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'https://api.shareus.io')
SHORTENER_API3 = environ.get("SHORTENER_API3", "5bc1c19a8ca807d70afe9788017076f621ba694c")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", 'https://nanolinks.in')
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002081252535')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002081252535'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002081252535')
